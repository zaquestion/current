...
func (s *grpcServer) PostLocationBigBrother(ctx context.Context, req *pb.PostLocationBigBrotherRequest) (*pb.Empty, error) {
...
func (s *grpcServer) PostLocationTasker(ctx context.Context, req *pb.PostLocationTaskerRequest) (*pb.Empty, error) {

...
func main() {
	...
	*/
	...
	var postlocationfrombigbrotherEndpoint endpoint.Endpoint
	{
		...
		postlocationfrombigbrotherEndpoint = svc.MakePostLocationFromBigBrotherEndpoint(service)
		...
		//postlocationfrombigbrotherEndpoint = svc.EndpointInstrumentingMiddleware(postlocationfrombigbrotherDuration)(postlocationfrombigbrotherEndpoint)
		//postlocationfrombigbrotherEndpoint = svc.EndpointLoggingMiddleware(postlocationfrombigbrotherLogger)(postlocationfrombigbrotherEndpoint)
	}
	...
	var getlocationEndpoint endpoint.Endpoint
	{
		...
		getlocationEndpoint = svc.MakeGetLocationEndpoint(service)
		//getlocationEndpoint = opentracing.TraceServer(tracer, "GetLocation)")(getlocationEndpoint)
		//getlocationEndpoint = svc.EndpointInstrumentingMiddleware(getlocationDuration)(getlocationEndpoint)
		//getlocationEndpoint = svc.EndpointLoggingMiddleware(getlocationLogger)(getlocationEndpoint)
	}

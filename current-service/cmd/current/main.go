...
func submain() int {
	...
	var (
		...
		flagSecretPostLocationTasker        = fsPostLocationTasker.String("secret", "", "")
		flagSecretGetLocation               = fsGetLocation.String("secret", "", "")
	)
	...
	case "getlocation":
		...
		SecretGetLocation := *flagSecretGetLocation

		request, err := handlers.GetLocation(SecretGetLocation)
		if err != nil {
	...
	case "postlocationtasker":
		...
		SecretPostLocationTasker := *flagSecretPostLocationTasker

		request, err := handlers.PostLocationTasker(LocationPostLocationTasker, SpeedPostLocationTasker, BatteryPostLocationTasker, ChargingPostLocationTasker, DateTimePostLocationTasker, SecretPostLocationTasker)
		if err != nil {
		...
		fmt.Println("Client Requested with:")
		fmt.Println(LocationPostLocationTasker, SpeedPostLocationTasker, BatteryPostLocationTasker, ChargingPostLocationTasker, DateTimePostLocationTasker, SecretPostLocationTasker)
		fmt.Println("Server Responded with:")
		fmt.Println(v)
